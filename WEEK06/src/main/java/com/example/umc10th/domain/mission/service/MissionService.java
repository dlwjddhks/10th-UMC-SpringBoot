...
public class MissionService {
    ...
    public List<response.MissionListResDTO> getMyMissions(Long userId, int page) {
        ...
        Page<UserMission> result = userMissionRepository
                .findByUserUserIdAndStatusIn(
                        userId,
                        List.of(Status.CHALLENGING, Status.COMPLETE),
                        pageRequest
                );
        return MissionConverter.toMissionList(result.getContent());
    }
}